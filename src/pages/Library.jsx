                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    <div className="bg-surface border border-border rounded-lg shadow-2xl w-full max-w-lg overflow-hidden">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div>
                                <label className="block text-xs font-bold text-textSecondary uppercase mb-1.5 ml-1">Visibility</label>
                                <select
                                    value={visibility}
                            ...
                            <div>
                                <label className="block text-xs font-bold text-textSecondary uppercase mb-1.5 ml-1">Git Token (Optional)</label>
                                <input
                                    type="password"
